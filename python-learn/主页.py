...
# 打开图像文件
image = Image.open('python-learn/2.jpg')
...
if option == '实际实验步骤':
    ...
    image = Image.open('python-learn/3.png')
...
if start_button:
    dongtu = st.empty()
    dongtu.image('python-learn/01000.gif', width=300)
    ...
    def main():
        ...
        while T < 189:   # 2.0-22    212-373
            ...
            time.sleep(1)
            if T >= 189:
                dongtu.image('python-learn/010001.png', width=300)
